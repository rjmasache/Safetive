        ...
        <div className="flex h-screen w-screen items-center bg-gray-100">
            <div className="container flex flex-col items-center justify-center px-5 text-gray-700 md:flex-row">
                <div className="max-w-md">
                    ...
                    <Link to={`/`}>
                        <button className="focus:shadow-outline-red inline rounded-lg border border-transparent bg-safetive p-3 px-4 py-2 text-sm font-medium leading-5 text-link shadow transition-colors duration-150 hover:bg-red-800 focus:outline-none active:bg-red-600">
                            Back to Safetive
                        </button>
                    </Link>
                </div>
